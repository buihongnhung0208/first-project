...
;
const prisma = new __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$first$2d$project$2f$lib$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PrismaClient"]().$extends({
    result: {
        product: {
            price: {
                compute (product) {
        ...
        async jwt ({ token, user, trigger, session }) {
            ...
            if (user) {
                ...
                if (user.name === 'NO_NAME') {
                    ...
                    await __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$first$2d$project$2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].user.update({
                        where: {
                            id: user.id
                        },
                        data: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__423f9403._.js.map