...
"[project]/lib/generated/prisma/runtime/library.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/db/prisma.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
const prisma = new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PrismaClient"]().$extends({
    result: {
        product: {
            price: {
                compute (product) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bcrypt$2d$ts$2d$edge$2f$dist$2f$node$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/bcrypt-ts-edge/dist/node.mjs [app-route] (ecmascript)");
    ...
    providers: [
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$node_modules$2f40$auth$2f$core$2f$providers$2f$credentials$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])({
            ...
            async authorize (credentials) {
                ...
                const user = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].user.findFirst({
                    where: {
                ...
                if (user && user.password) {
                    const isMatch = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bcrypt$2d$ts$2d$edge$2f$dist$2f$node$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["compareSync"])(credentials.password, user.password);
        ...
        async jwt ({ token, user, trigger, session }) {
            if (user) {
                ...
                if (trigger === 'signIn' || trigger === 'signUp') {
                    const cookiesObject = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$headers$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["cookies"])();
                    const sessionCartId = cookiesObject.get('sessionCartId')?.value;
                    if (sessionCartId) {
                        const sessionCart = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].cart.findFirst({
                            where: {
                                sessionCartId
                            }
                        });
                        if (sessionCart) {
                            ...
                            await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].cart.deleteMany({
                                where: {
                                    userId: user.id
                                }
                            });
                            // Assign the guest cart to the logged-in user
                            await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].cart.update({
                                where: {
                                    id: sessionCart.id
                                },
                                data: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8705178d._.js.map